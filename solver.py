...
####
                result_path = os.path.join(self.result_dir, a)
                save_image(self.denorm(x_real.data.cpu()), result_path, nrow=1, padding=0)

                for c_trg in c_trg_list:
                    b = ('{}-' + a).format(j + 1)
                    x_fake = self.G(x_real, c_trg)
                    # result_path = os.path.join(self.result_dir + j, b)
                    # save_image(self.denorm(x_real.data.cpu()), result_path, nrow=1, padding=0)

                    for x in x_fake:
                        if category == 0:
                            result_path = os.path.join(self.result_dir + '/0', b)
                        elif category == 1:
                            result_path = os.path.join(self.result_dir + '/1', b)
                        elif category == 2:
                            result_path = os.path.join(self.result_dir + '/2', b)
                        elif category == 3:
                            result_path = os.path.join(self.result_dir + '/3', b)
                        elif category == 4:
                            result_path = os.path.join(self.result_dir + '/4', b)
                        elif category == 5:
                            result_path = os.path.join(self.result_dir + '/5', b)
                        elif category == 6:
                            result_path = os.path.join(self.result_dir + '/6', b)
                        elif category == 7:
                            result_path = os.path.join(self.result_dir + '/7', b)
                            category = 0

                        save_image(self.denorm(x.data.cpu()), result_path, nrow=1, padding=0)
                        category = category + 1
                ...
                #     x_fake_list.append(self.G(x_real, c_trg))
                #
                #     for x in x_fake_list:
                #         # x_concat = torch.cat(x, dim=3)
                #         result_path = os.path.join(self.result_dir, '{}-images.jpg'.format(i + 1))
                #         save_image(self.denorm(x.data.cpu()), result_path, nrow=1, padding=0)
                #         print('Saved real and fake images into {}...'.format(result_path))
